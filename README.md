...
Wind & Solar Energy Production Dataset --> https://www.kaggle.com/datasets/ahmeduzaki/wind-and-solar-energy-production-dataset
...
2) Desafio Final — Análise de Dados de Energia com API Pública
